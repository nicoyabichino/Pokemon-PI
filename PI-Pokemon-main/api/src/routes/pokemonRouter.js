...
const {name, hp, attack, defense, speed, types, image, height, weight} = req.body;
...
else if(!image) {return res.status(404).send({error: "Falta agregar una imagen del Pokemon"})}
